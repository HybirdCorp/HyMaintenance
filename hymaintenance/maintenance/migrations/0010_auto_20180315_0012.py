...
def create_maintenance_type_if_needed(apps, schema_editor):
    ...
    MaintenanceType.objects.get_or_create(
        pk=2, defaults={"name": _("Support"), "css_class": "type-support", "label_for_company_detailview": _("Support")}
    )
    MaintenanceType.objects.get_or_create(
        pk=3,
        defaults={
...
class Migration(migrations.Migration):
    ...
    dependencies = [("maintenance", "0009_maintenancecontract_total_type")]

    operations = [migrations.RunPython(create_maintenance_type_if_needed, do_nothing)]
