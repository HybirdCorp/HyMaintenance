...
class CreateOperatorTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.form_url = reverse('high_ui:project-create_operator',
    ...
    def test_create_operator_with_form(self):
        ...
        issues = MaintenanceUser.objects.filter(email=email,
                                                first_name=first_name,
                                                last_name=last_name,
...
class UpdateOperatorWithCompanyTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.form_url = reverse('high_ui:project-update_operator',
                               kwargs={'company_name': cls.company.slug_name,
                                       'pk': cls.operator.pk})
        cls.login_url = reverse("login") + "?next=" + cls.form_url
    ...
    def test_update_operator_with_form(self):
        ...
        success_url = reverse('high_ui:project-update_operators',
                              kwargs={'company_name': self.company.slug_name})
        self.assertRedirects(response, success_url)
        operators = MaintenanceUser.objects.filter(email=email,
                                                   first_name=first_name,
                                                   last_name=last_name,
                                                   pk=self.operator.pk)
...
class UpdateOperatorTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.operator = OperatorUserFactory()
        cls.operator.operator_for.add(cls.company)
        cls.form_url = reverse('high_ui:update_operator',
                               kwargs={'pk': cls.operator.pk})
        cls.login_url = reverse("login") + "?next=" + cls.form_url
...
class UpdateOperatorUsersTestCase(TestCase):
    ...
    def test_post_archive_operators_form(self):
        ...
        self.assertRedirects(response, reverse('high_ui:dashboard'))
        operators = MaintenanceUser.objects.filter(email=op_email,
                                                   is_active=False)
        self.assertEqual(1, operators.count())
...
class UpdateOperatorUsersWithCompanyTestCase(TestCase):
    ...
    def setUpTestData(cls):
        cls.admin = AdminUserFactory(email="gordon.freeman@blackmesa.com",
                                     password="azerty")
        cls.company = CompanyFactory()
        cls.form_url = reverse('high_ui:project-update_operators',
                               kwargs={'company_name': cls.company.slug_name})
        cls.login_url = reverse("login") + "?next=" + cls.form_url
