    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', customers.fields.LowerCaseEmailField(db_index=True, error_messages={'unique': 'A user with that username already exists.'}, max_length=254, unique=True, verbose_name='email address')),
            ...
            managers=[
                ('objects', customers.models.user.MaintenanceUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Company',
